...
// WiFi Credentials
const char *ssid = "SCORPION_WIFI_IOT_NETWORK";            // Replace with your WiFi name
const char *password = "xxxxxxxxxxxxxxxxxxxx";  // Replace with your WiFi password
...
void setup() {
    dht.setup(21, DHTesp::DHT11); // Connect DHT sensor to GPIO 23
...
//        mqtt_client.publish(mqtt_topic, "89");
